...
let Renderer, Program, Mesh, Triangle, Vec3;
...
export const VoicePoweredOrb = ({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor3 = vec3(0.15, 0.2, 0.7);
      ...
      try {
        ...
        const update = (t) => {
          ...
          if (enableVoiceControl && isMicrophoneInitialized) {
            ...
            // Gentle idle animation when not using voice control
